<div>
    ...
    <div class="flex w-[260px] h-[160px] shrink-0 overflow-hidden mx-auto">
        <img id="main-thumbnail" src="{{ Storage::url($shoe->thumbnail) }}"
        ...
        <div class="flex flex-col rounded-[20px] p-4 mx-4 pb-5 gap-5 bg-white">
            <div id="info" class="flex items-center justify-between">
                <div class="flex flex-col">
                    <h1 id="title" class="font-bold text-[22px] leading-[30px]">{{ $shoe->name }}</h1>
                    <p class="font-semibold text-lg leading-[27px]">Rp{{ number_format($shoe->price, 0, ',', '.') }} •
                        {{ $orderData['shoe_size'] }}</p>
                </div>
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="relative flex items-center gap-[30px]">
                    ...
                    <button type="button" wire:click='incrementQuantity()'
                        class="flex w-full h-[54px] items-center justify-center rounded-full bg-primary overflow-hidden">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div
                    ...
                    <img src="{{ asset('assets/images/icons/discount-shape.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
                    <input type="text" wire:model.live.debounce.500ms='promoCode' name="promo" id="promo"
                        class="appearance-none outline-none w-full font-semibold placeholder:font-normal placeholder:text-[#878785] py-[14px]"
            ...
            <div class="flex items-center justify-between">
                ...
                <p class="font-bold">Rp{{ number_format($subTotalAmount, 0, ',', '.') }}</p>
            </div>
            <div class="flex items-center justify-between">
