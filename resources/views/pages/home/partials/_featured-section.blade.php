<section id="featured" class="flex flex-col gap-4" wire:ignore>
    ...
    <div class="swiper w-full overflow-hidden">
        <div class="swiper-wrapper">
            ...
            <x-product-card id="{{ $item->id }}" link="{{ route('front.details', $item->slug) }}" name="{{ $item->name }}" price="{{ $item->price }}" thumbnail="{{ $item->thumbnail }}" />
            @empty
